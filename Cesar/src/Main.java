...
//		String strCode = v.coder(str, "BVYVBNO");
...
//		System.out.println(v.decoderSansCle(strCode));
		System.out.println("Bonjour et bienvenu dans le programe de chiffrement \net déchiffrement selon les methodes César et Vigenère\n\n");
		while(entree != 7)
		{
			entree = 0;
			...
			case 5:
				...
				code = scan.next();
				System.out.println("Le message  \"" + code.toUpperCase() + "\" décodé est :\n\""  + v.decoderSansCle(code.toUpperCase()) + "/nLa clef est " + c.trouverClee(code.toUpperCase()) + "\"\nPour retourner au menu tapez n'importe quoi");
				clef = scan.next();
				break;
			case 6:
