...
public class Cesar {
	...
	public char decaler(char entree, int decalage)
	{
		...
		if(decalage<=0)
		{
			if(this.a.lettreCorrespondante(-decalage) == entree)
				return 'Z';
			return this.a.lettreCorrespondante((this.a.position(entree)+ 26 + decalage)%26);
		}else
		{
	...
	public String coder(String entree, char cle) {
		...
		{
			sortie = sortie.concat(Character.toString(this.decaler(entree.charAt(i),this.a.position(cle))));
		}
		return sortie;
	}
	...
	{
		float  freqFr[] = {0F,7.68F,0.8F,3.32F,3.6F,17.76F,1.06F,1.1F,0.64F,7.63F,0.19F,0F,5.89F,2.72F,7.61F,5.34F,3.24F,1.34F,6.81F,8.23F,7.3F,6.05F,1.27F,0F,0.54F,0.21F,0.07F};
		...
		return this.a.lettreCorrespondante(retour+4);
	}
